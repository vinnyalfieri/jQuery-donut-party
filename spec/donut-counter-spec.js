describe('DonutCounter', function() {
  beforeEach(function() {
    setFixtures('<body><div class="wrapper"><h1>Donut Party!</h1><h2 id="status"></h2><div id="guests"><h3>Guests: <span class="guest-count">0</span></h3><button class="add">+</button><button class="remove">-</button></div><div id="donuts"><h3>Donuts: <span class="donut-count">0</span></h3><button class="add">+</button><button class="remove">-</button></div><div id="check"><button>Check</button></div></div></body>');
